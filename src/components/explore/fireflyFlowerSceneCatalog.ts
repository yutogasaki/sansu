...
export const FIREFLY_FLOWER_SCENES: Record<FireflyFlowerSceneStage, {
    ...
    waiting: {
        src: "/assets/explore/firefly-flower/scene-waiting-stumble-bloom-pokko-v5.webp",
        description: "葉帽子のポッコが、一本の道に並ぶ四つのしずくと、大きな閉じた花を見ている。",
    },
    "dew-trail": {
        src: "/assets/explore/firefly-flower/scene-dew-trail-stumble-bloom-pokko-v5.webp",
        description: "ポッコが葉帽子に四つのしずくをのせ、閉じた花へ一歩ずつ運んでいる。",
    },
    "warm-bud": {
        src: "/assets/explore/firefly-flower/scene-warm-bud-stumble-bloom-pokko-v5.webp",
        description: "小さなでこぼこへ足が当たり、葉帽子が傾いて、四つのしずくが揺れている。",
    },
    "ringing-petals": {
        src: "/assets/explore/firefly-flower/scene-ringing-petals-stumble-bloom-pokko-v5.webp",
        description: "ポッコがでこぼこにつまずき、飛んだ四つのしずくで五枚の花びらが開く。",
    },
    "light-path": {
        src: "/assets/explore/firefly-flower/scene-light-path-stumble-bloom-pokko-v5.webp",
