...
describe('written row correction', () => {
    ...
    it('never fills absent input from an expected answer, including zeros and decimals', () => {
        expect(writtenRetryValues(['', '0', '8', '.', ''], ['2', '0', '1', '.', '0'])).toEqual(['', '0', '', '.', '']);
