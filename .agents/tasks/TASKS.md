...
- Whole-app UX/UI coherence：旧Exploreとの取り違え原因を整理し、通常devをIsland (`/#/island`)へ固定。core guardで起動設定・runtime identity・仕様01/06/15とmemory/ownership/計画/risk registerの現行ルールを検査。旧Exploreは任意副モード、Nature Town (`5233`)は別preview。5 viewportの97 route/action checksを再通過。短横画面のscroll案内と補助文字contrastを改善済みだが、参加者/実読み上げ評価と全route/state網羅は継続 -> docs/tasks/active/2026-09-20-whole-app-ux-coherence.md
