...
- `docs/memory.md` remains the durable project-memory SSOT.
...
- `design-system/MASTER.md` helps implementation, but `docs/07_ui_design_guideline.md` remains the design SSOT.
- Add `.codex/` only when the repo needs committed Codex-specific adapter files such as config or hook registration.

## Do Not Store Here

- Product behavior rules
- Long-term project truth already covered by `docs/memory.md`
