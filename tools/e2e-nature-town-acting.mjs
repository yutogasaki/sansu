...
try{
 for(const width of [390,768]){
  ...
  try{
   ...
   await page.goto(`${base}/#/nature-town`);await page.locator('[data-candidate="nature-town-acting-s2"]').waitFor();await pause();await shot('before-house','01');await choose('家');await page.locator('[data-cell="8,6"]').click();await confirm();await button(page,'せかい').click();await shot('placed-house','02');
