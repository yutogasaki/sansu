...
追補: 縦画面の室内カメラを `island-home-interior-v5` に変更。以下は最初のUI整理時点の証拠。後続の検証と公開状況は[カメラ追補](../2026-09-20-house-camera/README.md)を参照。
...
初回検証時点では未コミット・未公開。部屋を眺めながら、思い出や学びの記念を自分から開きたくなることが今回の仮説。子どもの再訪意欲は未観察。原画の作り直しや家具の追加、学習/保存の変更は行っていない。
