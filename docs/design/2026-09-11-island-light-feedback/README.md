...
公開 `https://sansu-seven.vercel.app`（配信revision `d13af6381c5cc84e02ca59d9a7927105c86602b4`）にも同じ本番ハーネスを実行し、phone/tabletともPASSだった。公開検査ではDEV時間送りを使わず、空島からの学習、住人の好み、ひかりの意味、いろ価格、reload、実サービスワーカー下のoffline回答と再起動を確認した。結果は `live-report.json` に残している。
