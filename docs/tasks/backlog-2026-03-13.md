# 2026-03-13 棚卸しの履歴（現行優先順位ではない）

2026-09-20に現行台帳から分離。現在は[バックログ](backlog.md)と[共有キュー](../../.agents/tasks/TASKS.md)を参照。以下の進捗率・未着手判定は再利用しない。
...
詳細: [当時のデザイン状態](archive/2026-03-17-design-refresh-status.md)
