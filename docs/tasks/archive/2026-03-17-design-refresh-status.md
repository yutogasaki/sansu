...
> 2026-09-20に履歴としてアーカイブ。デザイン原則の正本は `docs/product/07_ui_design_guideline.md`、現在の進行状況は `.agents/tasks/TASKS.md` と `docs/tasks/backlog.md` を参照する。以下の未完項目は再トリアージなしに現行の約束として扱わない。
