...
> 2026-09-08: [学習単元と習得証拠](31_learning_units_spec.md)を採用する。全教材の単元対応とLv11の比較試作を加え、新規回答の文脈を記録する。通常の出題・進行は仕様29を維持し、新判定の適用は比較検証後とする。

> 2026-09-08の新規成長契約は[育つ島](30_living_island_growth_spec.md)。学習区間の成果で同じ居場所を自動アップグレードし、住民の自発行動、任意の移動/外観選択、土地拡張、発見/成長アルバムへつなぐ。新方式では初回も含め受取・配置を強制せず連続学習する。旧予約・未受取・所有物は保持する。
