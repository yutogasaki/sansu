...
| マップ | ノード型15ノード、開始から終点まで8行動。道選択は3問区間の境界だけ |
...
| 帰還 | 任意帰還、エネルギー切れ帰還 |
| 再探索 | 帰還要約で未訪問ルートを1件予告し、別ルートへの再出発を促す |
...
- 通常起動から初問まで追加操作が最大1タップ、単独の最初の遭遇では0タップであること
