...
軽量化したwhole-flow candidate revision `2495f6cb31301eafb347eca0115321d9dc01a997` は、delivery `snap-root-v1`、lineage `pokko-field-v1` のexact detached buildから同じ390×844 / 768×1024の各16 stageとQ7 compositeを再収録した。通常しずく道、分岐、葉橋、root-tangle、観察、Q8、帰還は一輪・一人・四滴・一本の道、青緑・黄土橙・葉緑＋珊瑚accent、横長cameraを保持し、旧密集林、金色発光路、縦長遭遇plateを現行critical pathとPWA precacheから撤去した。author/benchmark visual診断は **52 / 60**、各軸8以上、runtime integrityは13 critical raster hash、decoded media、TenKey、overflow 0、mixed visible lineage 0、visible legacy 0でPASSとする。ただしGate Bの未説明5人は未実施であり、production defaultは `classic-v1` のまま、G5 / G6完了までHOLDとする。証跡は [Dew Path v3 exact-build audit](/docs/design/audits/2026-07-23-dew-path-v3-2495f6c/README.md) を参照する。
