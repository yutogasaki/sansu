...
- Learning units and evidence (2026-09-08): [31](../product/31_learning_units_spec.md) governs versioned unit mapping and the read-only Lv11 pilot; [32](../product/32_math_unit_catalog.md) and [33](../product/33_english_unit_catalog.md) hold math/English mappings. Do not infer missing evidence from old logs or enrich stored reservations. The pilot does not control planners, promotion or SRS. English recognition does not prove listening/speaking/writing. Three distinct problems and a 24-hour delayed check are comparison hypotheses, not validated optimal thresholds.
