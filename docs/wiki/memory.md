...
- Island customization (2026-09-08): [35](../product/35_island_customization_spec.md) adopts optional real-island previews, owned themes/accents, a desired item, and 10 cosmetic stars per committed completed learning section. Existing completedSets are backcredited once only while the optional v1 state is absent; never recompute a stored wallet after spending. Purchases and application use active-profile/CAS/receipt transactions. Preview is temporary; new growth memories freeze cosmetics and old memories retain the default. Learning/SRS and automatic growth remain separate.
...
- Island growth uses cumulative 1/3/6 completed sections per habitat, with east/west land at 2/12 total sections. The default first chapter matures all four habitats at 24 sections and then preserves a completed island. Appearance changes, storage, moving furniture and absence never reduce earned abilities or rewrite past snapshots. Discoveries record actual visible resident/nature behavior; merely satisfying a condition does not fill the album. Support earns world growth without being recorded as independent mastery.
